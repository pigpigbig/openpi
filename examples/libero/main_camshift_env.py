...
class Args:
    ...
    env_ids: Optional[List[int]] = None  # Optional env ids to evaluate (e.g. --env-ids 0)
    ...
    save_videos: bool = True  # set False to skip video saving
...
def eval_libero(args: Args):
    ...
    for task_id in tqdm.tqdm(task_ids):
        ...
        for episode_idx in tqdm.tqdm(range(args.num_trials_per_task)):
            ...
            if args.save_videos and replay_images and (episode_idx % args.save_video_every == 0):
