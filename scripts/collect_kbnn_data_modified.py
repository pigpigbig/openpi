    ...
    for env_id in env_ids:
        ...
        while successes < args.successes_per_env:
            ...
            while t < args.max_steps:
                ...
                if not saved_first_pair:
                    imageio.imwrite(out_root / "first_before_camshift.png", np.asarray(img))
                    imageio.imwrite(out_root / "first_after_camshift.png", np.asarray(camshift_img))
                    saved_first_pair = True
